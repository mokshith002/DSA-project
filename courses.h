...
map<string, course> findCourses(string year)
{
    ...
    if (year == "2021")
        freopen("./Courses/first_courses.txt", "r", stdin);
    if (year == "2020")
        freopen("./Courses/second_courses.txt", "r", stdin);
    if (year == "2019")
        freopen("./Courses/third_courses.txt", "r", stdin);
    if (year == "2018")
        freopen("./Courses/fourth_courses.txt", "r", stdin);
    ...
    for(auto [str, _course] : result) cout << str << "\n";
